...
class CInPlaceComboTP;
class CInPlaceEditTP;
...
// Implementation
	...
	CInPlaceComboTP* ShowInPlaceList(int iRowIndex, int iColumnIndex, CStringList& rComboItemsList, 
								   CString strCurSelecetion = "", int iSel = -1);

	// Creates and displays the in place edit control
	CInPlaceEditTP* ShowInPlaceEdit(int iRowIndex, int iColumnIndex, CString& rstrCurSelection);
