...
CInPlaceEditTP* CInPlaceEditTP::m_pInPlaceEdit = NULL;  

CInPlaceEditTP::CInPlaceEditTP()
{
	m_iRowIndex= -1;
	m_iColumnIndex = -1;
	m_bESC = FALSE;
...
BEGIN_MESSAGE_MAP(CInPlaceEditTP, CEdit)
	//{{AFX_MSG_MAP(CInPlaceEditTP)
	ON_WM_KILLFOCUS()
	ON_WM_CHAR()
...
/////////////////////////////////////////////////////////////////////////////
// CInPlaceEditTP message handlers

void CInPlaceEditTP::OnPaste(WPARAM /*wParam*/, LPARAM /*lParam*/)
{
...
void CInPlaceEditTP::OnKillFocus(CWnd* pNewWnd) 
{
...
void CInPlaceEditTP::OnChar(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
...
BOOL CInPlaceEditTP::PreTranslateMessage(MSG* pMsg) 
{
...
int CInPlaceEditTP::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
CInPlaceEditTP* CInPlaceEditTP::GetInstance()
{
	if(m_pInPlaceEdit == NULL)
	{
		m_pInPlaceEdit = new CInPlaceEditTP;
	}
	return m_pInPlaceEdit;
}

void CInPlaceEditTP::DeleteInstance()
{
	delete m_pInPlaceEdit;
	m_pInPlaceEdit = NULL;
}

BOOL CInPlaceEditTP::ShowEditCtrl(DWORD dwStyle, const RECT &rCellRect, CWnd* pParentWnd, 
