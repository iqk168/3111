...
class CInPlaceComboTP : public CComboBox
{
public:
...
// Implementation
	...
	static CInPlaceComboTP* GetInstance(); 
...
// Implementation
	...
	operator = (CInPlaceComboTP) {}

	// Destructor
	virtual ~CInPlaceComboTP();
...
// Attributes
	...
	// Singleton instance
	static CInPlaceComboTP* m_pInPlaceCombo;
