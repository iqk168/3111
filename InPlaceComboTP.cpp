...
CInPlaceComboTP* CInPlaceComboTP::m_pInPlaceCombo = NULL; 

CInPlaceComboTP::CInPlaceComboTP()
{
	m_iRowIndex = -1;
	m_iColumnIndex = -1;
	m_bESC = FALSE;
...
BEGIN_MESSAGE_MAP(CInPlaceComboTP, CComboBox)
	//{{AFX_MSG_MAP(CInPlaceComboTP)
	ON_WM_CREATE()
	ON_WM_KILLFOCUS()
	ON_WM_CHAR()
...
/////////////////////////////////////////////////////////////////////////////
// CInPlaceComboTP message handlers

int CInPlaceComboTP::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
BOOL CInPlaceComboTP::PreTranslateMessage(MSG* pMsg) 
{
...
void CInPlaceComboTP::OnKillFocus(CWnd* pNewWnd) 
{
...
void CInPlaceComboTP::OnChar(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
...
void CInPlaceComboTP::OnCloseup() 
{
	// Set the focus to the parent list control
	GetParent()->SetFocus();
}

CInPlaceComboTP* CInPlaceComboTP::GetInstance()
{
	if(m_pInPlaceCombo == NULL)
	{
		m_pInPlaceCombo = new CInPlaceComboTP;
	}
	return m_pInPlaceCombo;
}

void CInPlaceComboTP::DeleteInstance()
{
	delete m_pInPlaceCombo;
	m_pInPlaceCombo = NULL;
}

BOOL CInPlaceComboTP::ShowComboCtrl(DWORD dwStyle, const CRect &rCellRect, CWnd* pParentWnd, UINT uiResourceID,
