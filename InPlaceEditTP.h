...
class CInPlaceEditTP : public CEdit
{
...
// Implementation
	...
	static CInPlaceEditTP* GetInstance(); 
...
// Implementation
	...
	operator = (CInPlaceEditTP) {}
	
	// Destructor
	virtual ~CInPlaceEditTP();
...
// Attributes
	...
	// Singleton instance
	static CInPlaceEditTP* m_pInPlaceEdit;
