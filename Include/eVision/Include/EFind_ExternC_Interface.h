#ifndef __EFIND_EXTERNC_INTERFACE_H__
#define __EFIND_EXTERNC_INTERFACE_H__
...
extern "C"
{
  ...
  E_DLL0 int E_DLL1 PatternFinder_getFeatureSelection_EasyFindFeatureSelection(void* impl, int* retVal);
  E_DLL0 int E_DLL1 PatternFinder_setFeatureSelection_EasyFindFeatureSelection(void* impl, int retVal);
  ...
  E_DLL0 int E_DLL1 PatternFinder_getCoarseToFineAnalysisMode_EasyFindCoarseToFineAnalysisMode(void* impl, int* retVal);
  E_DLL0 int E_DLL1 PatternFinder_setCoarseToFineAnalysisMode_EasyFindCoarseToFineAnalysisMode(void* impl, int retVal);
  ...
  E_DLL0 int E_DLL1 PatternFinder_getPivot_NewPoint(void* impl, void** retVal);
  E_DLL0 int E_DLL1 PatternFinder_setPivot_NewPoint(void* impl, void* retVal);
...
E_DLL0 void E_DLL1  PatternFinder_SetCallback(void** impl, void* callback, int handle);
  ...
  E_DLL0 int E_DLL1 FoundPattern_getCenterX_FLOAT32(void* impl, float* retVal);
  E_DLL0 int E_DLL1 FoundPattern_setCenterX_FLOAT32(void* impl, float retVal);
  E_DLL0 int E_DLL1 FoundPattern_getCenterY_FLOAT32(void* impl, float* retVal);
  E_DLL0 int E_DLL1 FoundPattern_setCenterY_FLOAT32(void* impl, float retVal);
...
#endif // __EFIND_EXTERNC_INTERFACE_H__
