#if !defined(AFX_DLGSOCKETVISIONSETTING_H__4AC60F4F_DCD8_4730_9366_803DD693BB41__INCLUDED_)
#define AFX_DLGSOCKETVISIONSETTING_H__4AC60F4F_DCD8_4730_9366_803DD693BB41__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// DlgSocketVisionSetting.h : header file
//
...
class CDlgSocketVisionSetting : public CDialog
{
// Construction
public:
	CDlgSocketVisionSetting(CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	//{{AFX_DATA(CDlgSocketVisionSetting)
	enum { IDD = IDD_DLG_SOCKETVISION_SETTING };
...
// Overrides
	...
	//{{AFX_VIRTUAL(CDlgSocketVisionSetting)
	public:
...
protected:
	...
	//{{AFX_MSG(CDlgSocketVisionSetting)
...
#endif // !defined(AFX_DLGSOCKETVISIONSETTING_H__4AC60F4F_DCD8_4730_9366_803DD693BB41__INCLUDED_)
